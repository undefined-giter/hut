<template>
    <Head title="Politique de confidentialité | Cabane" />
...
Nous utilisons vos données personnelles pour fournir et améliorer le Service. En utilisant le Service, vous acceptez la collecte et l'utilisation des informations conformément à cette Politique de Confidentialité. Cette politique a été créée avec l'aide du Privacy Policy Generator.

Interprétation et Définitions
Interprétation
Les mots dont la première lettre est en majuscule ont des significations définies dans les conditions ci-dessous. Ces définitions ont la même signification, qu'elles apparaissent au singulier ou au pluriel.
...
Affilié : désigne une entité qui contrôle, est contrôlée par, ou est sous le même contrôle qu'une partie, où "contrôle" signifie la détention de 50 % ou plus des actions, des participations ou des valeurs mobilières ayant droit de vote pour l'élection des administrateurs ou de toute autre autorité de gestion.
Société (désignée soit comme "la Société", "Nous", "Notre" ou "Nos" dans cet Accord) fait référence à Cabane.
Cookies : sont de petits fichiers placés sur votre ordinateur, appareil mobile ou tout autre appareil par un site web, contenant des détails de votre historique de navigation sur ce site web parmi ses nombreuses utilisations.
Pays : se réfère à la France.
Appareil : désigne tout appareil permettant d'accéder au Service tel qu'un ordinateur, un téléphone mobile ou une tablette numérique.
...
Lorsque vous accédez au Service via un appareil mobile, nous pouvons collecter certaines informations automatiquement, y compris, mais sans s'y limiter, le type d'appareil mobile que vous utilisez, votre identifiant unique de l'appareil, l'adresse IP de votre appareil mobile, votre système d'exploitation mobile, le type de navigateur Internet mobile que vous utilisez, les identifiants uniques des appareils et d'autres données de diagnostic.

Nous pouvons également collecter les informations envoyées par votre navigateur chaque fois que vous visitez notre Service ou lorsque vous accédez au Service via un appareil mobile.
...
Vos informations, y compris les Données Personnelles, sont traitées aux bureaux de la Société et en tout autre lieu où les parties impliquées dans le traitement sont localisées.

Suppression de Vos Données Personnelles
Vous avez le droit de demander la suppression des Données Personnelles que nous avons collectées.

Divulgation de Vos Données Personnelles
Sous certaines circonstances, la Société peut être amenée à divulguer vos Données Personnelles si cela est requis par la loi ou en réponse à des demandes légitimes des autorités publiques.

Sécurité de Vos Données Personnelles
La sécurité de vos Données Personnelles est importante pour nous, mais n'oubliez pas qu'aucune méthode de transmission sur Internet ou méthode de stockage électronique n'est totalement sécurisée.
...
Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Cabane.
