<template>
    <Head title="Conditions d'utilisation | Cabane" />
...
Ce site web est exploité par Cabane. Partout sur le site, nous employons les termes « nous », « notre » et « nos » en référence à Cabane. Ce site web, y compris l'ensemble des informations, outils et services auquel il donne accès, est offert par Cabane à l'utilisateur que vous êtes, à condition que vous acceptiez la totalité des modalités, conditions, politiques et avis stipulés ici.
...
Les présentes Conditions d’utilisation, ainsi que tout accord distinct par lequel nous vous fournissons les Services sont régis et interprétés en vertu des lois de 972 Chenalbonne, Châtel-en-Trièves, Rhône-Alpes, 38710, France.
...
Les questions relatives aux Conditions d’utilisation doivent nous être envoyées à leo.ripert@gmail.com.

Conditions d'Utilisation Relative au Jacuzzi
L'utilisation du jacuzzi est soumise aux règles et conditions suivantes. En accédant au jacuzzi, vous acceptez de respecter ces directives strictes. Toute violation de ces règles peut entraîner une expulsion de la zone de baignade sans remboursement.

1. Interdiction d'accès aux mineurs
L'accès au jacuzzi est strictement réservé aux personnes âgées de 18 ans et plus. Les mineurs ne sont pas autorisés à utiliser le jacuzzi, même sous la surveillance d'un adulte.

2. Consommation de nourriture et de boissons
Interdiction de consommer de la nourriture : Il est strictement interdit de manger dans le jacuzzi ou aux abords immédiats de celui-ci.
Interdiction de boissons alcoolisées et autres : La consommation de boissons, y compris les boissons alcoolisées, est formellement interdite dans le jacuzzi. Aucun récipient, verre, ou bouteille ne doit être amené dans ou autour du jacuzzi.
Interdiction de fumer : Il est strictement interdit de fumer, y compris les cigarettes électroniques, dans ou autour de la zone du jacuzzi.

3. Hygiène et tenue appropriée
Tous les utilisateurs doivent prendre une douche avant d'entrer dans le jacuzzi.
Seuls les maillots de bain appropriés sont autorisés. Les vêtements de ville ou autres tenues sont interdits dans le jacuzzi.
...
5. Respect de la capacité maximale
La capacité maximale du jacuzzi doit être strictement respectée. En cas de surcharge, les utilisateurs excédentaires seront priés de quitter la zone.

6. Interdiction d'apporter des objets dangereux
Aucun objet en verre, pointu ou autre objet dangereux n'est autorisé dans ou autour du jacuzzi.

7. Conditions médicales
Toute personne souffrant de problèmes de santé tels que les maladies cardiaques, l’hypertension, ou les infections cutanées doit éviter l'utilisation du jacuzzi.
Les femmes enceintes sont fortement déconseillées d'utiliser le jacuzzi.
...
This website is operated by Cabane. Throughout the site, the terms "we," "us," and "our" refer to Cabane. This website, including all information, tools, and services available from this site, is offered by Cabane to you, the user, conditioned upon your acceptance of all terms, conditions, policies, and notices stated here.
...
You agree to indemnify, defend, and hold harmless Cabane and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns, and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third party due to or arising out of your breach of these Terms of Use or the documents they incorporate by reference, or your violation of any law or the rights of a third party.
...
These Terms of Use and any separate agreements whereby we provide you Services shall be governed by and construed in accordance with the laws of 972 Chenalbonne, Châtel-en-Trièves, Rhône-Alpes, 38710, France.
...
Questions about the Terms of Use should be sent to us at leo.ripert@gmail.com.


Jacuzzi Use Policy

The use of the jacuzzi is subject to the following strict rules and conditions. By accessing the jacuzzi, you agree to comply with these guidelines. Any breach of these rules may result in expulsion from the bathing area without refund.

Minors’ Access Restriction Access to the jacuzzi is strictly reserved for individuals aged 18 and over. Minors are not permitted to use the jacuzzi, even under adult supervision.

Consumption of Food and Beverages

Prohibition of Food Consumption: Eating in or around the jacuzzi area is strictly prohibited.
Alcoholic and Other Beverages Prohibition: The consumption of beverages, including alcoholic drinks, is strictly forbidden in the jacuzzi. No containers, glasses, or bottles may be brought into or near the jacuzzi.
Smoking Prohibition: Smoking, including electronic cigarettes, is strictly prohibited in or around the jacuzzi area.
Hygiene and Appropriate Attire

All users must shower before entering the jacuzzi.
Only proper swimwear is allowed. City clothing or other attire is not permitted in the jacuzzi.
The use of cosmetics, oils, lotions, or sunscreen is prohibited before entering the water.
Safety and Behavior

No Diving: The jacuzzi is not designed for diving. Jumping or diving is strictly prohibited.
No Running or Playing in the Jacuzzi Area: The jacuzzi area must remain calm and secure for all users. Playing or running is not allowed.
Use of Electronic Devices: Electronic devices (phones, speakers, etc.) are not allowed in or near the jacuzzi to prevent the risk of electric shock.
Maximum Capacity Respect The jacuzzi's maximum capacity must be strictly observed. In the event of overcrowding, excess users will be asked to leave the area.

Prohibition of Dangerous Objects No glass, sharp objects, or other dangerous items are allowed in or around the jacuzzi.

Medical Conditions

Any person suffering from health issues such as heart disease, high blood pressure, or skin infections should avoid using the jacuzzi.
Pregnant women are strongly advised against using the jacuzzi.
